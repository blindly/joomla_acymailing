...
<tr id="trphone">
        ...
        <td>
                <?php
                if(empty($this->subscriber->userid)){
                        echo '<input class="inputbox required" type="text" name="data[subscriber][phone]" id="phone" style="width:200px" value="'.$this->escape(@$this->subscriber->phone).'" />';
                }else{
                        echo $this->escape($this->subscriber->phone);
                }
                ?>
        </td>
</tr>
